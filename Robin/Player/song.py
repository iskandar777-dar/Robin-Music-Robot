...
from RobinMusic.decorators import humanbytes
...
@Client.on_message(command(["msong", f"msong@{bn}"]) & ~filters.edited)
def song(_, message):
...
async def lyrics(_, message):
    try:
        ...
        await rep.edit("❌ **ʟʏʀɪᴄs ɴᴏᴛ ғᴏᴜɴᴅ.**\n\n» **ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴀ ᴠᴀʟɪᴅ sᴏɴɢ ɴᴀᴍᴇ.**")

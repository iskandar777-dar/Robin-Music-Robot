...
import aiofiles
import aiohttp
from RobinMusic.converter import convert
import ffmpeg
import requests
from RobinMusic.fonts import CHAT_TITLE
...
from RobinMusic.utils import bash
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("❥ sᴜᴘᴘᴏʀᴛ", url="https://t.me/kakashi_bots_updates"),
                            InlineKeyboardButton("❥ ᴜᴘᴅᴀᴛᴇs", url="https://t.me/kakashi_bots_support")
                        ],
                        [
                            InlineKeyboardButton(" ᴄʟᴏsᴇ ", callback_data="cls")
                        ]
